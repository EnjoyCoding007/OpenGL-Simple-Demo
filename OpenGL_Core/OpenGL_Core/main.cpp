...
//  OpenGL_Core
//
//  Created by Sharon on 2019/5/21.
...
"void main()\n"
"{\n"
"   fColor = vec4(0.5f, 0.5f, 0.2f, 1.0f);\n"
"}\n\0";
...
int main()
{
    ...
    glVertexAttribPointer(0, 4, GL_FLOAT, GL_FALSE, 3*sizeof(float), (void*)0);    // Vertex attributes stay the same
